...
class Project:
    def initial_gui(self):
        ...
        image1 = Image.open("C:/Users/Lenovo/Desktop/PYTHON PROGRAMS/mustard.png.jpg")
...
#11
        ...
        btn1=Button(win,text="K-Nearest Neighbour",bg="black",fg="white",command=self.knn_output)  
        btn1.place(x=40,y=550)
        entry14=Entry(win,bg="white",fg="black",textvariable=ent14)
        entry14.place(x=200,y=550)
        
        btn2=Button(win,text="Decision Tree",bg="black",fg="white",command=self.dt_output)  
        btn2.place(x=40,y=580)
        entry15=Entry(win,bg="white",fg="black",bd=1,textvariable=ent15)
        entry15.place(x=200,y=585)
        
        btn3=Button(win,text="Support Vector Machine",bg="black",fg="white",command=self.svc_output)  
        btn3.place(x=40,y=610)
        entry16=Entry(win,bg="pink",fg="black",bd=1,textvariable=ent16)
        entry16.place(x=200,y=610)
